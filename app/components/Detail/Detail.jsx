  ...
  return (
    <>
        <div className="fixed inset-0 bg-black bg-opacity-30 backdrop-blur-sm flex justify-center items-center">
          <div className="justify-center sm:h-fit pb-8 sm:w-fit min-h-[150px] min-w-[450px] max-w-[600px] bg-blue-50 shadow-2xl border-2 border-slate-700 p-3 sm:rounded-3xl flex flex-col items-center gap-2 w-screen text-black">
